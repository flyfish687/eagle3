...
import com.dfsoft.constant.GlobalCons;
...
public class ResUtil {
    ...
    public static String getStaticPrefix(ServerHttpRequest request) {
    	String schema = request.getURI().getScheme();
        return schema + "://" + request.getHeaders().getFirst("x-forwarded-host") + IPTV_STATIC_PREFIX;
    }
}
